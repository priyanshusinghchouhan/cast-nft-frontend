...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-background via-background to-accent/5">
      ...
      {/* Hero Section */}
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-73px)] px-4 py-12 md:py-0 mt-2.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 w-full max-w-4xl mx-auto mb-4">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-muted-foreground mb-2">0.001 ETH</div>
            <p className="text-sm text-muted-foreground">Mint Price</p>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-muted-foreground mb-2">5</div>
